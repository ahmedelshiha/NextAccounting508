...
const TaskAnalytics = dynamic(() => import('./components/analytics/TaskAnalytics'), { ssr: false, loading: () => <div className="p-4 bg-white border rounded">Loading analytics...</div> })
