          ...
          {trend && (
            <div className="mt-4 h-2 bg-gray-100 rounded-full overflow-hidden">
              <div 
                ...
                style={{ width: `${Math.max(10, Math.min(100, (trend[0] || 0) * 10))}%` }}
              />
            </div>
          )}
        </CardContent>
...
function TasksInner() {
  ...
  const visible = useMemo(() => 
    sortTasks(filteredTasks as Task[], sortBy, true), 
    [filteredTasks, sortBy]
  )
  
  const stats = useMemo(() => 
    calculateTaskStatistics(visible as Task[]), 
    [visible]
  )
      ...
      <AnimatePresence>
        {error && (
          <motion.div
            ...
            className="mx-6 mt-4"
          >
            <div className="p-4 rounded-lg border border-red-200 bg-red-50 text-sm text-red-800 flex items-center space-x-2">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
              ...
              <div className="flex items-center space-x-4 flex-1 max-w-2xl">
                ...
                <Button
                  ...
                  className={`flex items-center space-x-2 ${
                    filtersActive > 0 ? 'border-blue-500 bg-blue-50 text-blue-600' : ''
                  }`}
                >
