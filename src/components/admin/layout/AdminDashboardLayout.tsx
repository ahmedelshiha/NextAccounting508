...
const AdminDashboardLayout: React.FC<AdminDashboardLayoutProps> = ({
  ...
  // Prepare responsive state with safe defaults for SSR/hydration consistency
  const effectiveSidebarCollapsed = isHydrated ? sidebar.collapsed : false
  const effectiveMobileOpen = isHydrated ? sidebar.open : false
  ...
  return (
    <AdminErrorBoundary>
      <div className={`h-screen bg-gray-50 overflow-hidden ${className}`}>
        ...
        {/* Mobile Backdrop */}
        {responsive.isMobile && effectiveMobileOpen && (
          <div
      ...
      <div className={`min-h-full flex flex-col transition-all duration-300 ${getContentClasses()}`}>
        ...
        <AdminHeader
          ...
          isMobileMenuOpen={effectiveMobileOpen}
        />
