...
export default function PreferencesTab({ loading }: PreferencesTabProps) {
  ...
  return (
    <div className="mt-4 space-y-6">
      {/* Sub-tabs for organizing preferences */}
      <Tabs value={activeSubTab} onValueChange={setActiveSubTab}>
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="notifications" className="flex items-center gap-2">
            <Bell className="h-4 w-4" />
            <span className="hidden sm:inline">Booking Notifications</span>
        ...
        <TabsContent value="localization" className="space-y-6 mt-4">
          <div>
