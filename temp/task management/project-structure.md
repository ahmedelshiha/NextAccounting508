...
- [ ] Define API/DB ↔ UI adapter mapping (Prisma enums/status/priority vs UI types)
- [ ] Implement temp/lib/tasks/adapters.ts and wire into temp/hooks to consume /api/admin/tasks
- [ ] Scaffold admin pages under temp (mirror target): temp/task management/src/app/admin/tasks/{page.tsx,[id]/page.tsx,loading.tsx}
