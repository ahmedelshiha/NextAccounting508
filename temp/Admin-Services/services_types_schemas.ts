...
export interface BulkAction {
  ...
  serviceIds: string[];
  value?: string | number; // For category or price updates
}
...
export const CreateServiceFormSchema = ServiceSchema;
export const UpdateServiceFormSchema = ServiceSchema.partial();
